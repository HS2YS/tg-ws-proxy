...
|---|---|---|
| `--port` | `1443` | Порт прокси в диапазоне `1..65535` |
| `--host` | `127.0.0.1` | Хост прокси |
| `--public-host` | | Публичный IPv4-адрес или DNS-имя только для формирования ссылки `tg://proxy` |
| `--public-port` | | Публичный порт `1..65535` только для формирования ссылки `tg://proxy` |
